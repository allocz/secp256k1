...
// Normalize is a no-op.  It is provided to keep API parity with [FieldVal64].
...
// time.  The ignored parameter exists to keep API parity with [FieldVal64].
//
// The field value is returned to support chaining.  This enables syntax like:
...
// modified.  The ignored parameter exists to keep API parity with [FieldVal64].
//
// The field value is returned to support chaining.  This enables syntax like:
