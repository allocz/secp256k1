...
func BenchmarkECDSASignatureFromBytes64(b *testing.B) {
	var sigb [64]byte
...
func BenchmarkECDSASignatureFromDER(b *testing.B) {
	var sigb [64]byte
	var sig ECDSASignature

	for b.Loop() {
		sig.FromDER(rov.sigder[:], false)
	}
...
func BenchmarkECDSASignatureToBytes64(b *testing.B) {
	var sigb [64]byte
	var sig ECDSASignature
	sig.FromBytes64(rov.sigb[:])
...
func BenchmarkECDSASignatureToDER72(b *testing.B) {
	var buf72 [72]byte
	var sigders []byte
	var sig ECDSASignature
	sig.FromBytes64(rov.sigb[:])
	...
	for b.Loop() {
		sigders = sig.ToDER72(buf72[:])
	}

	if !bytes.Equal(rov.sigder[:], sigders[:]) {
		b.Errorf("serialized DER signatures do not match")
	}
}
...
func initROVars() roVars {
	...
	htob(rov.sigb[:], "B81960B4969B423199DEA555F562A66B7F49DEA5836A0168361F1A5F8A3C8298"+"03EEA7D7EE4462E3E9D6D59220F950564CAEB77F7B1CDB42AF3C83B013FF3B2F")
	...
	rov.sigder = htos("30" + "45" + "02" + "21" + "00B81960B4969B423199DEA555F562A66B7F49DEA5836A0168361F1A5F8A3C8298" + "02" + "20" + "03EEA7D7EE4462E3E9D6D59220F950564CAEB77F7B1CDB42AF3C83B013FF3B2F")
	return rov
}
